...
python ./Nexus5XPkg/ImageResources/LGE/mkbootimg.py --kernel ./Build/LGG4-AARCH64/DEBUG_GCC5/FV/Image.gz-dtb --dt ./Nexus5XPkg/ImageResources/H815/msm8992-lge-h815-dt.img --ramdisk ./Nexus5XPkg/ImageResources/ramdisk-null --base 0x00000000 --pagesize 4096 --ramdisk_offset 0x02000000 --tags_offset 0x01e00000 -o ./Nexus5XPkg/ImageResources/H815/uefi_h815.img
